...
import { Card, Button, Modal, Input, Spinner, Badge, apiClient } from '@medisync/ui';
import { Plus, Calendar, FileText, ArrowLeft, ClipboardList, CheckCircle } from 'lucide-react';
