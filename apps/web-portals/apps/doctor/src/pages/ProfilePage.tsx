  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '28px', alignItems: 'start' }}>
      ...
      <Card style={{ padding: '32px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: '20px' }}>
        <Avatar name={user?.fullName || 'Doctor'} size={80} />
        <div>
          <h3 style={{ fontWeight: 800, fontSize: '1.25rem', marginBottom: '4px' }}>Dr. {user?.fullName}</h3>
          <p style={{ fontSize: '0.8125rem', color: 'var(--text-secondary)' }}>Clinical Doctor Profile</p>
        </div>
        ...
        <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '12px', textAlign: 'left' }}>
          ...
          <div style={{ display: 'flex', gap: '10px', alignItems: 'center', fontSize: '0.8125rem', color: 'var(--text-secondary)' }}>
            <Shield size={14} />
            <span>Role Coordinate: {user?.role}</span>
          </div>
        </div>
      </Card>
      ...
      <Card style={{ padding: '32px' }}>
        <h3 style={{ fontSize: '1.125rem', fontWeight: 700, marginBottom: '24px' }}>Edit Clinical Coordinate parameters</h3>
        ...
        {success && (
          <div style={{
            ...
            <CheckCircle size={16} />
            Clinical coordinates updated successfully
          </div>
        )}
        ...
        <form onSubmit={handleUpdate} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <Input
            ...
            placeholder="Clinical Practitioner Name"
            value={fullName}
          ...
          <Input
            label="Registered Phone Parameter"
