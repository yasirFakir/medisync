...
import { Search, Save, CheckCircle, AlertTriangle } from 'lucide-react';
...
export const UpdateStockPage: React.FC = () => {
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '28px', alignItems: 'start' }}>
      ...
      {/* Edit Inventory stock values card */}
      <Card style={{ padding: '24px' }}>
        <h3 style={{ fontSize: '1rem', fontWeight: 700, marginBottom: '20px' }}>Post Inventory Update</h3>
        ...
        {selectedDrug ? (
          <form onSubmit={handleUpdate} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <Button type="submit" loading={saving} icon={<Save size={16} />} style={{ width: '100%', marginTop: '10px' }}>
              Save Stock Status
            </Button>
          </form>
        ) : (
