// ─────────────────────────────────────────────────────────────────────────────
// @medisync/shared-types — Single source of truth for all domain types
// Used by: apps/backend, apps/web-portals, apps/mobile-app
// ─────────────────────────────────────────────────────────────────────────────
...
export interface GenericAlternative {
  ...
  isGeneric: boolean;
  trustRating: number;
  score: number; // Computed: (0.60 × Pscore) + (0.40 × Qscore)
}
